...
public class ConditionByLocationDTO {
  ...
  public ConditionByLocationDTO id(@jakarta.annotation.Nullable Long id) {
  ...
  public ConditionByLocationDTO createdAt(@jakarta.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public ConditionByLocationDTO updatedAt(@jakarta.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  public ConditionByLocationDTO isDeleted(@jakarta.annotation.Nullable Boolean isDeleted) {
  ...
  public ConditionByLocationDTO deletedAt(@jakarta.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public ConditionByLocationDTO deletedBy(@jakarta.annotation.Nullable UUID deletedBy) {
  ...
  public ConditionByLocationDTO promotion(@jakarta.annotation.Nonnull PromotionDTO promotion) {
