...
public class KeycloakUserDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<KeycloakUserDTO> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<KeycloakUserDTO> DECODER =
   ...
   */
  public static BinaryMessageEncoder<KeycloakUserDTO> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<KeycloakUserDTO> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<KeycloakUserDTO> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this KeycloakUserDTO to a ByteBuffer.
  ...
  /**
   * Deserializes a KeycloakUserDTO from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a KeycloakUserDTO instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static KeycloakUserDTO fromByteBuffer(
   ...
   */
  public KeycloakUserDTO(java.util.UUID id, java.lang.String username, java.lang.String email, java.util.UUID realmId, java.util.UUID userId) {
    this.id = id;
  ...
  /**
   * Creates a new KeycloakUserDTO RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new KeycloakUserDTO RecordBuilder by copying an existing KeycloakUserDTO instance.
  ...
  /**
   * RecordBuilder for KeycloakUserDTO instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<KeycloakUserDTO>
    implements org.apache.avro.data.RecordBuilder<KeycloakUserDTO> {
    ...
    public KeycloakUserDTO build() {
      try {
        KeycloakUserDTO record = new KeycloakUserDTO();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<KeycloakUserDTO>
    WRITER$ = (org.apache.avro.io.DatumWriter<KeycloakUserDTO>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<KeycloakUserDTO>
    READER$ = (org.apache.avro.io.DatumReader<KeycloakUserDTO>)MODEL$.createDatumReader(SCHEMA$);
