...
public class NotificationDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public NotificationDTO(java.util.UUID id, java.util.UUID recipientId, java.lang.String type, java.lang.String title, java.lang.String message, java.lang.Boolean isRead, java.lang.String relatedEntityType, java.util.UUID relatedEntityId, java.time.Instant createdAt, java.time.Instant scheduledAt) {
    this.id = id;
