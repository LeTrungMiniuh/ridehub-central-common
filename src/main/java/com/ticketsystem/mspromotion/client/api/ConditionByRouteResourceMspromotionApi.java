...
public interface ConditionByRouteResourceMspromotionApi extends ApiClient.Api {
  ...
  * but this one also exposes the Http response headers
  ...
  public static class CountConditionByRoutesQueryParams extends HashMap<String, Object> {
    ...
    public CountConditionByRoutesQueryParams routeIdEquals(@jakarta.annotation.Nullable final UUID value) {
      put("routeId.equals", EncodingUtils.encode(value));
      return this;
    }
    public CountConditionByRoutesQueryParams routeIdNotEquals(@jakarta.annotation.Nullable final UUID value) {
      put("routeId.notEquals", EncodingUtils.encode(value));
      return this;
    }
    public CountConditionByRoutesQueryParams routeIdSpecified(@jakarta.annotation.Nullable final Boolean value) {
      put("routeId.specified", EncodingUtils.encode(value));
      return this;
    }
    public CountConditionByRoutesQueryParams routeIdIn(@jakarta.annotation.Nullable final List<UUID> value) {
      put("routeId.in", EncodingUtils.encodeCollection(value, "multi"));
      return this;
    }
    public CountConditionByRoutesQueryParams routeIdNotIn(@jakarta.annotation.Nullable final List<UUID> value) {
  ...
  * but this one also exposes the Http response headers
  ...
  public static class GetAllConditionByRoutesQueryParams extends HashMap<String, Object> {
    ...
    public GetAllConditionByRoutesQueryParams routeIdEquals(@jakarta.annotation.Nullable final UUID value) {
      put("routeId.equals", EncodingUtils.encode(value));
      return this;
    }
    public GetAllConditionByRoutesQueryParams routeIdNotEquals(@jakarta.annotation.Nullable final UUID value) {
      put("routeId.notEquals", EncodingUtils.encode(value));
      return this;
    }
    public GetAllConditionByRoutesQueryParams routeIdSpecified(@jakarta.annotation.Nullable final Boolean value) {
      put("routeId.specified", EncodingUtils.encode(value));
      return this;
    }
    public GetAllConditionByRoutesQueryParams routeIdIn(@jakarta.annotation.Nullable final List<UUID> value) {
      put("routeId.in", EncodingUtils.encodeCollection(value, "multi"));
      return this;
    }
    public GetAllConditionByRoutesQueryParams routeIdNotIn(@jakarta.annotation.Nullable final List<UUID> value) {
      put("routeId.notIn", EncodingUtils.encodeCollection(value, "multi"));
      return this;
    }
