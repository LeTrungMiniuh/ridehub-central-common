...
@JsonPropertyOrder({
  ...
  ConditionByRouteDTO.JSON_PROPERTY_ROUTE_ID,
...
public class ConditionByRouteDTO {
  ...
  public ConditionByRouteDTO routeId(@jakarta.annotation.Nonnull UUID routeId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, conditionByRouteDTO.id) &&
        Objects.equals(this.routeId, conditionByRouteDTO.routeId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, routeId, createdAt, updatedAt, isDeleted, deletedAt, deletedBy, promotion);
  }
